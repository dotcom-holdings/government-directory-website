...
<head>
  ...
  <title>Epyderm - Company Stats - Governement Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Epyderm</b> &nbsp; - &nbsp; Visitor Stats for period 24/11/2017 - 28/02/2018
      </h1>
...
$total_hits = round(($one*2),0)+round(($two*2.9),0)+round(($three*2.9),0)+round(($four*2.9),0);
?>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Nov 2017", "Dec 2017", "Jan 2018", "Feb 2018"],
      datasets: [
        {
          label: "Average Hits",
