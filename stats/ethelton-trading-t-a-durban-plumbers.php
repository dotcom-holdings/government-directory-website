...
<head>
  ...
  <title>Ethelton Trading t/a Durban Plumbers - Company Stats - Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Ethelton Trading t/a Durban Plumbers</b> &nbsp; - &nbsp; Visitor Stats for period 01/06/2018 - 31/10/2018
      </h1>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Jun 2018", "Jul 2018", "Aug 2018", "Sep 2018", "Oct 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.9),0)?>, <?=round(($three*2.85),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.5),0)?>]
        },
        {
          label: "Listing Hits",
