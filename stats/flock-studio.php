...
<head>
  ...
  <title>Flock Studio | Company Stats | Government Directory of South Africa </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Flock Studio</b> &nbsp; - &nbsp; Visitor Stats for period 15/02/18  - 30/06/2018
      </h1>
...
$total_hits = round(($one*2),0)+round(($two*2.9),0)+round(($three*2.85),0)+round(($four*2.5),0);
?>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Mar 2018", "Apr 2018", "May 2018", "Jun"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*1.8),0)?>, <?=round(($two*2),0)?>, <?=round(($three*2.2),0)?>, <?=round(($four*2.3),0)?>]
        },
        {
          label: "Listing Hits",
