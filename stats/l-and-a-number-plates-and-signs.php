...
<head>
  ...
  <title>L and A Number Plates And Signs - Company Stats - Government Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> L and A Number Plates And Signs</b> &nbsp; - &nbsp; Visitor Stats for period 15/06/2018 - 31/07/2018
      </h1>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Jun 2018", "Jul 2018", "Aug 2018", "Sep 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*1.9),0)?>, <?=round(($two*2),0)?>, <?=round(($three*3),0)?>, <?=round(($four*2.5),0)?>]
        },
        {
          label: "Listing Hits",
