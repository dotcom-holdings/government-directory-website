...
<head>
  ...
  <title>Vital Pest Control / Zululand - Richards Bay | Company Analitics | Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Vital Pest Control / Zululand - Richards Bay </b> &nbsp; - &nbsp; Visitor Stats for period 27/08/2018 - 24/10/2018
      </h1>
...
$total_hits = round(($one*3)+($two*2.5)+($three*2.85),0);
?>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Aug 2018", "Sep 2018", "Oct 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.5),0)?>, <?=round(($three*2.85),0)?>]
        },
        {
          label: "Listing Hits",
