...
<head>
  ...
  <title>Lavender Hill Country Estate - Company Stats - Government Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Lavender Hill Country Estate</b> &nbsp; - &nbsp; Visitor Stats for period 01/03/2018 - 31/07/2018
      </h1>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Mar 2018", "Apr 2018", "May 2018", "Jun 2018", "Jul 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*3),0)?>, <?=round(($three*3),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.78),0)?>]
        },
        {
          label: "Listing Hits",
