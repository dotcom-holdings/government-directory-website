...
<head>
  ...
  <title>Orion Hotel Group - Company Stats - Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Orion Hotel Group</b> &nbsp; - &nbsp; Visitor Stats for period 4/12/2017 - 31/01/2018
      </h1>
...
$total_hits = round(($one*3),0)+round(($two*2.9),0);
?>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["December 2017", "January 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*1.5),0)?>, <?=round(($two*1.2),0)?>]
        },
        {
          label: "Listing Hits",
