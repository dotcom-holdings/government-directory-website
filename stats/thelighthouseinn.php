...
<head>
  ...
  <title>@ The Lighthouse Inn - Company Stats - Government Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> @ The Lighthouse Inn</b> &nbsp; - &nbsp; Visitor Stats for period 01/09/2017 - 28/02/2018
      </h1>
...
$total_hits = round(($one*3),0)+round(($two*2.9),0)+round(($three*2.85),0)+round(($four*2.5),0)+round(($five*2.6),0)+round(($six*2.2),0);
?>
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?=$one?>, <?=$two?>, <?=$three?>, <?=$four?>, <?=$five?>, <?=$six?></div>
                      <h5 class="description-header"><?=$total?></h5>
                      <span class="description-text">Visits</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*7/100)?>, <?= round($two*7/100)?>, <?= round($three*7/100)?>,<br><?= round($four*7/100)?>, <?= round($five*7/100)?>, <?= round($six*7/100)?></div>
                      <h5 class="description-header">7%</h5>
                      <span class="description-text">Referral</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*93/100)?>, <?= round($two*93/100)?>, <?= round($three*93/100)?>,<br><?= round($four*93/100)?>, <?= round($five*93/100)?>, <?= round($six*93/100)?></div>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["September 2017", "October 2017", "November 2017", "December 2017", "Jan 2018","Feb 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*3),0)?>, <?=round(($three*3),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.78),0)?>, <?=round(($six*2.9),0)?>]
        },
        {
          label: "Listing Hits",
