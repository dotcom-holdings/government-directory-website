...
<head>
  ...
  <title>Security Experts - Company Stats - Government Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Security Experts</b> &nbsp; - &nbsp; Visitor Stats for period 15/03/2017 - 31/01/2018
      </h1>
...
$total_hits = round(($one*3),0)+round(($two*2.9),0)+round(($three*2.85),0)+round(($four*2.5),0)+round(($five*2.6),0)+round(($six*2.2),0)+round(($seven*1.8),0)+round(($eight*1.6),0)+round(($nine*1.4),0)+round(($ten*1.2),0)+round(($eleven*1.1),0)+round(($twelve*1.1),0);
?>
      ...
      datasets: [
        {
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.9),0)?>, <?=round(($three*2.85),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.6),0)?>, <?=round(($six*2.2),0)?>, <?=round(($seven*1.8),0)?>, <?=round(($eight*1.8),0)?>, <?=round(($nine*1.8),0)?>, <?=round(($ten*1.8),0)?>, <?=round(($eleven*1.8),0)?>, <?=round(($twelve*1.8),0)?>]
        },
        {
          label: "Listing Hits",
