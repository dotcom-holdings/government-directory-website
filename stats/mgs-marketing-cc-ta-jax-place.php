...
<head>
  ...
  <title>MGS Marketing CC t/a Jax Place - Company Stats - Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> MGS Marketing CC t/a Jax Place</b> &nbsp; - &nbsp; Visitor Stats for period 01/08/2018 - 31/10/2018
      </h1>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["August 2018", "September 2018", "October 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.9),0)?>, <?=round(($three*2.8),0)?>]
        },
        {
          label: "Listing Hits",
