...
<head>
  ...
  <title>Industrial Development Corporation - Company Stats - Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Industrial Development Corporation</b> &nbsp; - &nbsp; Visitor Stats for period 25/04/2018 - 31/10/2018
      </h1>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Apr 2018", "May 2018", "Jun 2018", "Jul 2018", "August 2018", "September 2018", "October 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.9),0)?>, <?=round(($three*2.85),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.6),0)?>, <?=round(($six*2.2),0)?>, <?=round(($seven*2.1),0)?>]
        },
        {
          label: "Listing Hits",
