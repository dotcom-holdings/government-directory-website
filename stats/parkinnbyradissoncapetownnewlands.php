...
<head>
  ...
  <title>Park Inn by Radisson Cape Town Newlands | Company Analitics | Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Park Inn by Radisson Cape Town Newlands</b> &nbsp; - &nbsp; Visitor Stats for period 10/04/2018 - 30/11/2018
      </h1>
...
$total_hits = round(($one*3),0)+round(($two*2.9),0)+round(($three*2.85),0)+round(($four*2.5),0)+round(($five*2.6),0)+round(($six*2.2),0)+round(($seven*1.8),0)+round(($eight*1.8),0);
?>
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?=$one?>, <?=$two?>, <?=$three?>,<?=$four?>, <?=$five?>, <?=$six?>, <?=$seven?>, <?=$eight?></div>
                      <h5 class="description-header"><?=$total?></h5>
                      <span class="description-text">Visits</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*7/100)?>, <?= round($two*7/100)?>, <?= round($three*7/100)?>,<br><?= round($four*7/100)?>, <?= round($five*7/100)?>, <?= round($six*7/100)?>, <?= round($seven*7/100)?>, <?= round($eight*7/100)?></div>
                      <h5 class="description-header">7%</h5>
                      <span class="description-text">Referral</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*93/100)?>, <?= round($two*93/100)?>, <?= round($three*93/100)?>,<br><?= round($four*93/100)?>, <?= round($five*93/100)?>, <?= round($six*93/100)?>, <?= round($seven*93/100)?>, <?= round($eight*93/100)?></div>
      ...
      datasets: [
        {
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.5),0)?>, <?=round(($three*2.85),0)?>,<?=round(($four*3),0)?>, <?=round(($five*2.5),0)?>, <?=round(($six*2.85),0)?>, <?=round(($seven*2.85),0)?>, <?=round(($eight*2.4),0)?>]
        },
        {
          label: "Listing Hits",
