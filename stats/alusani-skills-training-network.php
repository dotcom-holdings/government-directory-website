...
<head>
  ...
  <title>Alusani Skills & Training Network ® (Pty) Ltd | Company Analitics | Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Alusani Skills & Training Network ® (Pty) Ltd</b> &nbsp; - &nbsp; Visitor Stats for period 01/07/2018 - 31/07/2018 
      </h1>
      ...
      datasets: [
        {
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.5),0)?>]
        },
        {
          label: "Listing Hits",
