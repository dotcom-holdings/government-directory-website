...
<head>
  ...
  <title>De Witt Enterprises (Pty) Ltd | Company Stats | Government Directory of South Africa </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> De Witt Enterprises (Pty) Ltd</b> &nbsp; - &nbsp; Visitor Stats for period 01/05/18  - 30/09/2018
      </h1>
...
$total_hits = round(($one*2),0)+round(($two*2.9),0)+round(($three*2.85),0)+round(($four*2.5),0)+round(($four*2.5),0);
?>
      ...
      datasets: [
        {
          ...
          data: [<?=round(($one*1.8),0)?>, <?=round(($two*2.9),0)?>, <?=round(($three*2.5),0)?>, <?=round(($four*2.3),0)?>, <?=round(($five*2.3),0)?>]
        },
        {
          label: "Listing Hits",
