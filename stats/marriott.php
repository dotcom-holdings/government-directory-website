...
<head>
  ...
  <title>Protea Hotel by Marriott Polokwane - Company Stats - Government Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Protea Hotel by Marriott Polokwane</b> &nbsp; - &nbsp; Visitor Stats for period 22/02/2017 - 28/02/2018
      </h1>
...
$total_hits = round(($one*3),0)+round(($two*2.9),0)+round(($three*2.85),0)+round(($four*2.5),0)+round(($five*2.6),0)+round(($six*2.2),0)+round(($seven*1.8),0)+round(($eight*1.6),0)+round(($nine*1.4),0)+round(($ten*1.2),0)+round(($eleven*1),0)+round(($twelve*1),0)+round(($thirteen*1),0);
?>
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    ...
                    <!-- /.description-block -->
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*7/100)?>, <?= round($two*7/100)?>, <?= round($three*7/100)?>,<br><?= round($four*7/100)?>, <?= round($five*7/100)?>, <?= round($six*7/100)?>, <?= round($seven*7/100)?>, <?= round($eight*7/100)?>, <?= round($nine*7/100)?>, <?= round($ten*7/100)?>, <?= round($eleven*7/100)?>, <?= round($twelve*7/100)?>, <?= round($thirteen*7/100)?></div>
        ...
        <div class="box box-warning">
          ...
          <div class="box-body">
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><b><?=round(($total_hits*0.1),0)?></b>/<?=$total_hits?></span>
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><b><?=round(($total_hits*0.3),0)?></b>/<?=$total_hits?></span>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["feb 2017","Mar 2017","Apr 2017","May 2017","Jun 2017", "Jul 2017", "Aug 2017", "Sep 2017", "Oct 2017", "Nov 2017", "Dec 2017", "Jan 2018", "Feb 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.9),0)?>, <?=round(($three*2.85),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.6),0)?>, <?=round(($six*2.2),0)?>, <?=round(($seven*2.1),0)?>, <?=round(($eight*2.1),0)?>, <?=round(($nine*2.2),0)?>, <?=round(($ten*2.3),0)?>, <?=round(($eleven*2.4),0)?>, <?=round(($twelve*2.4),0)?>, <?=round(($thirteen*2.4),0)?>]
        },
        {
          label: "Listing Hits",
