...
<head>
  ...
  <title>Orchards Executive Accommodation Midrand - Company Stats - Government Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Orchards Executive Accommodation Midrand</b> &nbsp; - &nbsp; Visitor Stats for period 01/07/2018 - 14/11/2018
      </h1>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Jul 2018", "Aug 2018", "Sep 2018", "Oct 2018", "Nov 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*1.9),0)?>, <?=round(($two*2),0)?>, <?=round(($three*3),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.5),0)?>]
        },
        {
          label: "Listing Hits",
