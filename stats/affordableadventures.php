...
<head>
  ...
  <title>Affordable Adventures | Company Stats | Governement Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Affordable Adventures</b> &nbsp; - &nbsp; Visitor Stats for period 15/03/2018 - 01/05/2018
      </h1>
...
$total_hits = round(($one*2),0)+round(($two*2.9),0)+round(($three*2.9),0);
?>
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?=$one?>, <?=$two?>, <?=$three?></div>
                      <h5 class="description-header"><?=$total?></h5>
                      <span class="description-text">Visits</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*7/100)?>, <?= round($two*7/100)?>, <?= round($three*7/100)?></div>
                      <h5 class="description-header">7%</h5>
                      <span class="description-text">Referral</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*93/100)?>, <?= round($two*93/100)?>, <?= round($three*93/100)?></div>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Mar 2018", "Apr 2018", "May 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*2.5),0)?>, <?=round(($two*2.4),0)?>, <?=round(($three*2.3),0)?>, <?=round(($four*2.2),0)?>]
        },
        {
          label: "Listing Hits",
