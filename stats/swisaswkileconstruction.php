...
<head>
  ...
  <title>Swisasekile Construction - Company Stats - Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Swisasekile Construction</b> &nbsp; - &nbsp; Visitor Stats for period 25/07/2017 - 31/01/2018
      </h1>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Jul 2017", "August 2017", "September 2017", "October 2017", "November 2017", "December 2017", "January 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.9),0)?>, <?=round(($three*2.85),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.5),0)?>, <?=round(($six*2.5),0)?>, <?=round(($seven*2.5),0)?>,]
        },
        {
          label: "Listing Hits",
