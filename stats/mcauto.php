    ...
    <header class="main-header" style="background-color:#000;">
        ...
        <section class="content-header" style="background-color:#000;">
            <h1 style="margin-top:-6px; background-color:#000;">
                ...
                &nbsp; &nbsp;&nbsp;&nbsp;<b> MC AUTO - MCA STORE</b> &nbsp; - &nbsp; Visitor Stats for period 22/02/2017 - 30/06/2017
            </h1>
...
<!-- Left side column. contains the logo and sdebar -->
                                ...
                                <div class="col-md-3 col-sm-4">
                                    <div class="pad box-pane-right bg-green" style="min-height: 280px">
                                        <div class="description-block margin-bottom">
                                            ...
                                            <h5 class="description-header">2014</h5>
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <div class="progress-group">
                                ...
                                <span class="progress-number"><b>1822</b>/2110</span>
                            ...
                            <div class="progress-group">
                                ...
                                <span class="progress-number"><b>153</b>/2110</span>
                            ...
                            <div class="progress-group">
                                ...
                                <span class="progress-number"><b>2110</b>/1316262</span>
...
<script language="javascript">
    ...
    $(function(){
        ...
        var PieData = [
            {
                value: Math.round(2014*47/100),
                color: "#f56954",
                highlight: "#f56954",
                label: "Chrome"
            },
            {
                value: Math.round(2014*15/100),
                color: "#00a65a",
                highlight: "#00a65a",
                label: "IE"
            },
            {
                value: Math.round(2014*9/100),
                color: "#f39c12",
                highlight: "#f39c12",
                label: "FireFox"
            },
            {
                value: Math.round(2014*22/100),
                color: "#00c0ef",
                highlight: "#00c0ef",
                label: "Safari"
            },
            {
                value: Math.round(2014*5/100),
                color: "#3c8dbc",
                highlight: "#3c8dbc",
                label: "Opera"
            },
            {
                value: Math.round(2014*2/100),
                color: "#d2d6de",
                highlight: "#d2d6de",
                label: "Navigator"
            }
