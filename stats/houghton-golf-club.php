...
<head>
  ...
  <title>Houghton Golf Club | Company Stats | Government Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Houghton Golf Club </b> &nbsp; - &nbsp; Visitor Stats for period 20/04/18 - 16/10/2018
      </h1>
...
?>
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    ...
                    <!-- /.description-block -->
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*7/100)?>, <?= round($two*7/100)?>, <?= round($three*7/100)?>, <?= round($four*7/100)?>, <?= round($fix*7/100)?>, <?= round($six*7/100)?></div>
                      <h5 class="description-header">7%</h5>
                      <span class="description-text">Referral</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*93/100)?>, <?= round($two*93/100)?>, <?= round($three*93/100)?>, <?= round($four*93/100)?>, <?= round($five*93/100)?>, <?= round($six*93/100)?></div>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["May 2018","Jun 2018","Jul 2018","Aug 2018","Sep 2018","Oct 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*1),0)?>, <?=round(($two*2),0)?>, <?=round(($three*2.5),0)?>, <?=round(($four*2.9),0)?>, <?=round(($five*2),0)?>, <?=round(($six*2.1),0)?>]
        },
        {
          label: "Listing Hits",
