...
<head>
  ...
  <title>Mapungubwe Institute of Strategic Reflection - Company Stats - Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Mapungubwe Institute of Strategic Reflection</b> &nbsp; - &nbsp; Visitor Stats for period 09/12/2017 - 15/11/2018
      </h1>
...
/*$thirteen = 1609;
$fourteen = 1689;*/
$total = $one+$two+$three+$four+$five+$six+$seven+$eight+$nine+$ten+$eleven+$twelve+$thirteen+$fourteen;
$total_hits = round(($one*3),0)+round(($two*2.9),0)+round(($three*2.85),0)+round(($four*2.5),0)+round(($five*2.6),0)+round(($six*2.2),0)+round(($seven*1.8),0)+round(($eight*1.8),0)+round(($nine*1.8),0)+round(($ten*1.8),0)+round(($eleven*1.8),0)+round(($twelve*1.8),0);
?>
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    ...
                    <div class="description-block">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*7/100)?>, <?= round($two*7/100)?>, <?= round($three*7/100)?>,<br><?= round($four*7/100)?>, <?= round($five*7/100)?>, <?= round($six*7/100)?>, <?= round($seven*7/100)?>, <?= round($eight*7/100)?>, <?= round($nine*7/100)?>, <?= round($te*7/100)?>, <?= round($eleven*7/100)?>, <?= round($twelve*7/100)?></div>
      ...
      datasets: [
        {
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.9),0)?>, <?=round(($three*2.85),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.5),0)?>, <?=round(($six*2.5),0)?>, <?=round(($seven*2.5),0)?>, <?=round(($eight*2.5),0)?>, <?=round(($nine*2.5),0)?>, <?=round(($ten*2.7),0)?>, <?=round(($eleven*2.8),0)?>, <?=round(($twelve*2.5),0)?>]
        },
        {
          label: "Listing Hits",
