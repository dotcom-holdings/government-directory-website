...
<head>
  ...
  <title>Executive Business Solutions - Company Stats - Government Directory </title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Executive Business Solutions</b> &nbsp; - &nbsp; Visitor Stats for period 15/11/2016 - 30/11/2017
      </h1>
...
$total_hits = round(($one*2),0)+round(($two*2.9),0)+round(($three*2),0)+round(($four*2.9),0)+round(($five*2),0)+round(($six*2.9),0)+round(($seven*2),0)+round(($eight*2.9),0)+round(($nine*2),0)+round(($ten*2.9),0)+round(($eleven*2),0)+round(($twelve*2.9),0)+round(($ten*2),0)+round(($six*2.9),0);
?>
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?=$one?>, <?=$two?>, <?=$three?>,<?=$four?>,<?=$five?>,<?=$six?>,<?=$seven?>,<?=$eight?>,<?=$nine?>,<?=$ten?>,<?=$eleven?>,<?=$twelve?></div>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Nov 2016","Dec 2016","Jan 2017","Feb 2017","Mar 2017","Apr 2017","May 2017","Jun 2017","Jul 2017","Aug 2017","Sep 2017","Oct 2017","Nov 2017"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*1.9),0)?>, <?=round(($two*1.9),0)?>,<?=round(($three*1.9),0)?>,<?=round(($four*2),0)?>,<?=round(($five*1.9),0)?>,<?=round(($six*2),0)?>,<?=round(($seven*2.1),0)?>,<?=round(($eight*2.4),0)?>,<?=round(($nine*2.7),0)?>,<?=round(($ten*2.9),0)?>,<?=round(($eleven*2.9),0)?>,<?=round(($twelve*2.9),0)?>,<?=round(($twelve*3),0)?>,<?=round(($twelve*3),0)?>]
        },
        {
          label: "Listing Hits",
          ...
          data: [<?=$one?>, <?=$two?>, <?=$three?>,<?=$four?>,<?=$five?>,<?=$six?>,<?=$seven?>,<?=$eight?>,<?=$nine?>,<?=$ten?>,<?=$eleven?>,<?=$twelve?>,<?=$ten?>,<?=$twelve?>]
        }
      ]
    };
