...
<head>
  ...
  <title>The Spotted Grunter Resort | Company Analitics | Government Directory</title>
...
<div class="wrapper">
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <img src="dist/img/GN_logo.fw.png" style="height:45px;margin-top:-7px;">
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> The Spotted Grunter Resort</b> &nbsp; - &nbsp; Visitor Stats for period 10/08/2017 - 31/10/2017
      </h1>
                ...
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    ...
                    <div class="description-block">
                      <div class="sparkbar pad" data-color="#fff"><?= round($one*93/100)?>,<?= round($one*93/100)?></div>
