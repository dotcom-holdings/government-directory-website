...
<div class="wrapper">
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      <h1 style="margin-top:-6px; background-color:#000;">
      <img src="dist/img/government.png" style="height:45px;margin-top:-7px;">
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> Caterweb</b> &nbsp; - &nbsp; Visitor Stats for period 06/04/2017 - 31/05/2017
      </h1>
                ...
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff">45,148</div>
                      <h5 class="description-header">193</h5>
                      <span class="description-text">Visits</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><?= round(45*7/100)?>, <?= round(148*7/100)?></div>
                      <h5 class="description-header">7%</h5>
                      <span class="description-text">Referral</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block">
                      <div class="sparkbar pad" data-color="#fff"><?= round(45*93/100)?>, <?= round(148*93/100)?></div>
          ...
          <!-- DONUT CHART -->
				<div class="box box-warning">
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><b>174</b>/193</span>
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><b>19</b>/193</span>
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><b>193</b>/1316372</span>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 by African Directory Services. All Rights Reserved. 
...
$(function () {
 ...
 //-------------
    ...
    var PieData = [
      {
        value: Math.round(193*47/100),
        color: "#f56954",
        highlight: "#f56954",
        label: "Chrome"
      },
      {
        value: Math.round(193*30/100),
        color: "#00a65a",
        highlight: "#00a65a",
        label: "IE"
      },
      {
        value: Math.round(193*9/100),
        color: "#f39c12",
        highlight: "#f39c12",
        label: "FireFox"
      },
      {
        value: Math.round(193*7/100),
        color: "#00c0ef",
        highlight: "#00c0ef",
        label: "Safari"
      },
      {
        value: Math.round(193*5/100),
        color: "#3c8dbc",
        highlight: "#3c8dbc",
        label: "Opera"
      },
      {
        value: Math.round(193*2/100),
        color: "#d2d6de",
        highlight: "#d2d6de",
        label: "Navigator"
      }
...
$(function () {
  ...
  $('#world-map-markers').vectorMap({
    ...
    markers: [
      ...
      {latLng: [-22.33, 24.45], name: 'Botswana'},
