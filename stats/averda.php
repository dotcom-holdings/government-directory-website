...
<head>
  ...
  <title>AVERDA - Company Stats - Government Directory</title>
  ...
  <header class="main-header" style="background-color:#000;">
    ...
    <section class="content-header" style="background-color:#000;">
      ...
      <span style="width:150px;">&nbsp;</span>
        &nbsp; &nbsp;&nbsp;&nbsp;<b> AVERDA</b> &nbsp; - &nbsp; Visitor Stats for period 11/10/2017 - 30/06/2018
      </h1>
...
$(function () {
    ...
    var areaChartData = {
      labels: ["Oct 2017", "Nov 2017", "Dec 2017", "Jan 2018", "Feb 2018", "Mar 2018", "Apr 2018", "May 2018", "Jun 2018"],
      datasets: [
        {
          label: "Average Hits",
          ...
          data: [<?=round(($one*3),0)?>, <?=round(($two*2.9),0)?>, <?=round(($three*2.85),0)?>, <?=round(($four*2.5),0)?>, <?=round(($five*2.5),0)?>, <?=round(($six*2.5),0)?>, <?=round(($seven*2.5),0)?>, <?=round(($eight*2.5),0)?>, <?=round(($nine*2.5),0)?>]
        },
        {
          label: "Listing Hits",
