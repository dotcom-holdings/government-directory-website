...
(function() {
  ...
  EkkoLightbox.prototype = {
    ...
    showInstagramVideo: function(id) {
      ...
      this.resize(width);
      height = width - 280;
      this.lightbox_body.html('<iframe class="video-iframe" src="' + this.addTrailingSlash(id) + 'embed/" frameborder="0" allowfullscreen></iframe>');
    ...
    showVideoIframe: function(url, width, height) {
      height = height || width;
      this.resize(width);
      this.lightbox_body.html('<div class="embed-responsive embed-responsive-16by9"><iframe class="video-iframe" src="' + url + '" frameborder="0" allowfullscreen class="embed-responsive-item"></iframe></div>');
      this.options.onContentLoaded.call(this);
      if (this.modal_arrows) {
    ...
    loadRemoteContent: function(url) {
      ...
      width = this.$element.data('width') || 650;
      this.resize(width);
      ...
      if (!disableExternalCheck && !this.isExternal(url)) {
        ...
        this.lightbox_body.html('<iframe class="video-iframe" src="' + url + '" frameborder="0" allowfullscreen></iframe>');
        this.options.onContentLoaded.call(this);
      }
      if (this.modal_arrows) {
        this.modal_arrows.css('display', 'none');
