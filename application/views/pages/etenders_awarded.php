...
$html = new simple_html_dom();
$html->load_file("http://www.etenders.gov.za/content/awarded-tenders");
...
foreach($html->find('a') as $link){
    ...
    $link->href = "http://test.adslive.com/govnews/home//etenders_awarded/www.etenders.gov.za".$newlink;
}
...
margin-right: 30px !important;
	...
	<h6 class="view" style="color: #333"><?php echo "<a href=\"javascript:history.go(-1)\"><< Back</a>";?></h6>
         <h2 class="right-line view">Awarded Tenders</h2>
		
<h6 class="view" style="color: #333">
	<a href="<?php echo base_url()?>home/tenders/tips">Tips for Tendering </a>|
	<a href="<?php echo base_url()?>home/view/etenders_category">Category Information</a>|
	<a href="<?php echo base_url()?>home/tenders/financial">Financial Support</a> | 
	<a href="<?php echo base_url()?>home/tenders/non-financial">Non-financial Support</a>|
	...
	<a href="<?php echo base_url()?>home/view/etenders_awarded">Awarded Tenders</a>| 
	<a href="<?php echo base_url()?>home/view/etenders_closed">Closed Tenders</a>|
	<a href="<?php echo base_url()?>home/view/etenders_cancelled">Cancelled Tenders</a>
</h6>
