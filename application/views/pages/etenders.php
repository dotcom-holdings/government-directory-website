...
$html = new simple_html_dom();
$html->load_file("http://www.etenders.gov.za/content/advertised-tenders");
...
foreach($html->find('a') as $link){
    ...
    $link->href = base_url()."home/etenders/www.etenders.gov.za".$newlink;
}
...
<br/><br/><br/><br/><br/><br/><br/>
	   ...
	   <?php  include("menu2.php"); ?> 
         <h2 class="right-line view" style="margin-left:20px;">Advertised Tenders</h2>
