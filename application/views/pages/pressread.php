...
$title = $html->find('h2[class=itemTitle]',0);
$con_div = $html->find('div[class=itemFullText]',0);
...
?>
 ...
 <div id="sidebar-left" class="col-lg-3" style="padding-left:0px;"><br/><br/><br/><br/><br/><br/>
...
<!--            <h2 class="right-line">Latest Press Releases</h2>-->
        </div><br/><br/>
       <br/><br/> <h6><a href="http://test.adslive.com/government.co.za/home/view/press">Press release ></a></h6><br/>
	<h4 style="color: black;">   
      <strong> <?php echo $title->plaintext;?></strong>
	</h4>
		 <div style="max-height: 2850px;overflow-y: scroll;">
		 <ul class="list-group" style="line-height: 25px;font-size:14px;">
			 <li class="list-group-item">
		     
				 <?php echo $con_div->plaintext;?>
