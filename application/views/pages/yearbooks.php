...
$html = new simple_html_dom();
$html->load_file("http://www.gcis.gov.za/content/resourcecentre/sa-info/yearbook");


$con_div = $html->find('li',22);
$con_div2 = $html->find('li',23);
//get value plaintext each html

foreach($html->find('a') as $link){
	$newlink=str_replace("https://","","$link->href");$link->href;
    $link->href = base_url()."pages/yearbooks/".$newlink;
}
...
th{
	...
	<div class="col-md-12">
		<br><?php echo "<a href=\"javascript:history.go(-1)\"><< Back</a>";?>
            <h2 class="right-line">South African Year Book</h2>
        </div>
	
		 <h4>The South Africa Yearbook gives a comprehensive account of the programmes and policies of our government as well as the current state of the South African nation. This publication is the official authoritative reference work on the Republic of South Africa and is updated annually. The Yearbook is now on Facebook. Just click on the image below or search for South Africa Yearbook, then click on "Like", then let all your friends "Like" it.</h4>
