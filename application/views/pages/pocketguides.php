...
$html = new simple_html_dom();
$html->load_file("http://www.gcis.gov.za/content/resourcecentre/sa-info/pocketguide");
...
foreach($html->find('a') as $link){
    ...
    $link->href = base_url()."pages/pocketguides/".$newlink;
}
...
th{
	...
	<div class="col-md-12">
           <br><?php echo "<a href=\"javascript:history.go(-1)\"><< Back</a>";?>
            <h2 class="right-line">Pocket Guides SA</h2>
        </div>
	
		 <h4>Content of the quick-fact, easy-to-read publication is largely based on information contained in the latest edition of the South Africa Yearbook, which is also published by the GCIS.

Similar to the objectives of the SA Yearbook, the Pocket Guide is also aimed at providing a useful reference tool to inform South Africans and the world of efforts of government and the people of South Africa to create a better life for all. </h4>
