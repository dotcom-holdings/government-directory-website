...
$html = new simple_html_dom();
$html->load_file("http://www.gpwonline.co.za/Gazettes/Pages/Published-Tender-Bulletin.aspx?p=1");

$con_div = $html->find('ul[class="dfwp-column dfwp-list"]',0);
//get value plaintext each html

foreach($html->find('div[style="width:200px; float:right;"]') as $div1){
