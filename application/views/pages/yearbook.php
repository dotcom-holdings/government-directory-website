...
$html = new simple_html_dom();
$html->load_file("http://www.gcis.gov.za/content/resourcecentre/sa-info/".$link5);

$con_div = $html->find('p',4);
$con_div1 = $html->find('p',5);
//get value plaintext each html

foreach($html->find('a') as $link){
	$newlink=str_replace("http://","","$link->href");$link->href;
    $link->href = "http://www.gcis.gov.za".$newlink;
}
?>
...
th{
	...
	<h6><?php
		$link6=str_replace("yearbook","<strong>Yearbook</strong> ","$link5");
		echo ucfirst($link6);?></h6>
