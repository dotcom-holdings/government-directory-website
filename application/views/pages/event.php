...
$con_div = $html->find('div[class=field field-name-body field-type-text-with-summary field-label-hidden]',0);
...
td{
     ...
     <div class="container" >
	<div class="col-md-12">
            <h2 class="right-line">Event</h2>
        </div>
	<h3 style="color: #3367D6">   
       <?php echo $title->plaintext;?>
	</h3>
		 
		 <ul class="list-group" >
			 <li class="list-group-item" style="height: 700px;overflow: scroll">
