...
$html = new simple_html_dom();
$html->load_file("http://www.gcis.gov.za/content/resourcecentre/sa-info/pocket-guide/".$link6."");

$con_div = $html->find('ul',3);
...
th{
	...
	<div class="col-md-12">
        <br><?php echo "<a href=\"javascript:history.go(-1)\"><< Back</a>";?>
         <h2 class="right-line">South African Pocketguide</h2>
		 </div>
	<h6><?php
