            ...
            <?php foreach ($classified_images_top as $image_top){ 
				$image_top_link = $image_top->name."<br><a href='http://".$image_top->website."' target='_blank'>Visit Website</a>"; ?>
                 ...
                 <div class="banner-widget">
					<a href="<?php echo HTTP_BASE_PATH.'home/lightbox_company/'.$image_top->id; ?>" data-toggle="lightbox" id="pop" data-title="Company Details"><img style="margin-bottom:20px;width:100%;" src="<?php echo CDN_BASE_PATH.$image_top->url; ?>"></a>
					<?php } else {?>
				<a href="<?php echo CDN_BASE_PATH.$image_top->url; ?>" data-toggle="lightbox" id="pop" data-title="<?php echo $image_top->name; ?>"><img style="margin-bottom:20px;width:100%;" src="<?php echo CDN_BASE_PATH.$image_top->url; ?>"></a>
				<?php }?>
                </div>
            <?php }?>
			</div> 
...
<div id="sidebar-left">
    ...
    <div class="banners">
				...
				$image_left_link = $image_left->name."<br><a href='http://".$image_left->website."' target='_blank'>Visit Website</a>"; ?>
                 ...
                 <div class="content">
					<a href="<?php echo HTTP_BASE_PATH.'home/lightbox_company/'.$image_left->id; ?>" data-toggle="lightbox" id="pop" data-title="Company Details"><img class="rightad-image" src="<?php echo CDN_BASE_PATH.$image_left->url; ?>"></a>
					<?php } else {?>
				<a href="<?php echo CDN_BASE_PATH.$image_left->url; ?>" data-toggle="lightbox" id="pop" data-title="<?php echo $image_left->name; ?>"><img class="carousal" src="<?php echo CDN_BASE_PATH.$image_left->url; ?>"></a>
				<?php }?>
                </div>
            	<?php }?>
    </div>
...
<div class="banners">
			<?php foreach ($classified_images_top_banner as $image_top_banner){ 
				$image_top_banner_link = $image_top_banner->name."<br><a href='http://".$image_top_banner->website."' target='_blank'>Visit Website</a>"; ?>
                 ...
                 <div class="banner-widget">
					<a href="<?php echo HTTP_BASE_PATH.'home/lightbox_company/'.$image_top_banner->id; ?>" data-toggle="lightbox" id="pop" data-title="Company Details"><img width="468" height="60" src="<?php echo CDN_BASE_PATH.$image_top_banner->url; ?>"></a>
					<?php } else {?>
				<a href="<?php echo CDN_BASE_PATH.$image_top_banner->url; ?>" data-toggle="lightbox" id="pop" data-title="<?php echo $image_top_banner->name; ?>"><img width="468" height="60" src="<?php echo CDN_BASE_PATH.$image_top_banner->url; ?>"></a>
				<?php }?>
                </div>
            <?php }?>
</div>
...
<div class="government-info">
	<h2>Government Information</h2>
		...
		<dl>    
		    ...
		    <dd><a href="<?php echo HTTP_BASE_PATH; ?>home/links/home-and-safety">Home Safety</a></dd>
		...
		<dl>
		    ...
		    <dd><a href="<?php echo HTTP_BASE_PATH; ?>home/links/owing-property">Owing Property</a></dd>
...
<div class="items" style="height:1580px;overflow-y: scroll;">

<?php include($type.'.html');?>
...
<div id="sidebar-right">
    ...
    <div class="banners">
    		...
    		<?php foreach ($classified_image_top_right as $image_right){ 
				$image_right_link = $image_right->name."<br><a href='http://".$image_right->website."' target='_blank'>Visit Website</a>"; ?>
                 ...
                 <div class="content">
					<a href="<?php echo HTTP_BASE_PATH.'home/lightbox_company/'.$image_right->id; ?>" data-toggle="lightbox" id="pop" data-title="Company Details"><img class="rightad-image" src="<?php echo CDN_BASE_PATH.$image_right->url; ?>"></a>
					<?php } else {?>
				<a href="<?php echo CDN_BASE_PATH.$image_right->url; ?>" data-toggle="lightbox" id="pop" data-title="<?php echo $image_right->name; ?>"><img class="carousal" src="<?php echo CDN_BASE_PATH.$image_right->url; ?>"></a>
				<?php }?>
                </div>
            <?php }?>
    ...
    <div id="video-ad">
        <h2>&nbsp;&nbsp;Video Ads</h2>
            ...
            <figure>
                <a href="https://www.youtube.com/watch/v/<?php echo $video->url; ?>" data-toggle="lightbox" data-gallery="youtubevideos" data-title="<?php echo $video->name;?>">
    ...
    <div id="twitter-updates" style="border:solid 1px silver;border-radius:5px;height:350px;padding:5px;overflow-y: hidden">
