...
<body class="fixed-sn black-skin"> <script>
    ...
    <!--Main layout-->
        ...
        <div class="container-fluid">
            ...
            <h5 style="color:#243D7B">Your Advert has been shown <span class="badge light-blue animated pulse infinite"><div id="div10">
                      		<img src="<?php echo HTTP_IMAGES_PATH; ?>loading1.gif" alt=""   height="50" />
								  ...
								  </script> </span> times so far on this website.</h5> 
...
<hr>
               <div class="row mb-1"> 
                ...
                <div class="col-3">
                    ...
                    <div class="data-card text-center">
                        <h3><div id="div6"><img src="<?php echo HTTP_IMAGES_PATH; ?>loading1.gif" alt=""   height="50" />
					 	</div>
					 	<script>
					$(document).ready(function(){
                ...
                <div class="col-3">
                    ...
                    <div class="data-card text-center">
                        <h3><div id="div7"><img src="<?php echo HTTP_IMAGES_PATH; ?>loading1.gif" alt=""   height="50" />
					 	</div>
					 	<script>
					$(document).ready(function(){ 
                ...
                <div class="col-3">
                    ...
                    <div class="data-card text-center">
                        <h3><div id="div8"><img src="<?php echo HTTP_IMAGES_PATH; ?>loading1.gif" alt=""   height="50" />
					 	</div>
					 	<script>
					$(document).ready(function(){
