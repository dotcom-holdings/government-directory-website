...
define('WEBSITE_ID',13); 
define('COUNTRY','za');
define('COUNTRY_ID','202');
define('COUNTRY_NAME','South Africa');
define('WEBSITE_NAME','Government South Africa');
...
define('CDN_BASE_PATH', 'http://cdn.adslive.com/');//take out deptcapture for live ******
...
|
*/
$config['encryption_key'] = 'Dot Com Admin Panel WITH BOOTSTRAP';
